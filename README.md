...
You have seen a few workflows in this repository. They are quality-gates to prevent duplication, control complexity and prove functionality. Do you think some of them have potential to guide code-improvements in your team? **Yes. It can definitely improve the code quality as the code will be further modified for multiple features and bug fixes. These quality gates are really helpful to analyze the code quality a well as the structure**

During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
**I plan to refactor some of the old codes in the repository. Also I can analyze and make sure the complexity parameters are taken care for all teh new features im going to implement**
